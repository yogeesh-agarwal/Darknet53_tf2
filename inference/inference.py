...
if __name__ == "__main__":
    ...
    test_pic_file = "../data/wider_test_file.pickle"
    neg_test_pic_file = "../data/neg_samples_test.pickle"
    data_path = "/home/yogeesh/yogeesh/datasets/face_detection/wider face/WIDER_test/images"
    if inference_model:
        ...
        classifier = get_infer_classifier(conv_weights_file , bn_weights_file , dense_weights_file)
    else:
